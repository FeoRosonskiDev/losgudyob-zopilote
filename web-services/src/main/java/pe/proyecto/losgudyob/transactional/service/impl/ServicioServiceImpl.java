...
public class ServicioServiceImpl implements ServicioService {
	...
	public ServicioUpdateModelResponse updateService(ServicioUpdateModelRequest request) {
		...
		/* TODO: validar el precio correctamente. La solución izi podría
		*  ser cambiar el tipo de dato de Double a String, así no se
		*  autocompleta el double a la hora de leerlo 8)
		*/
		if(!request.getPrecio().toString().matches("^[0-9]+(\\.[0-9]+)?$"))
