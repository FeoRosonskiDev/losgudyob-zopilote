...
public class ClienteRepositoryTest extends BaseTest {
	...
	/*
	 * si van a correr el test de insertClient, recuerden que acá aún no están las
	 * validaciones, así que cambien los datos. Especialmente correo y dni, el resto
	 * w.e. PD: no es que no funcione si lo corren con los mismos datos, pero
	 * causará problemas con el findByCorreo y findByDni, ya que esos métodos
	 * esperan 1 cliente o ninguno y si le meten los mismos datos no podrá
	 * guardarlos, so cuidado. PD2: lo otro es que borren los registros de la db dps
	...
	public void deleteClient() {
		...
		System.out.println("El cliente eliminado es: " + cliente.getNombre());
	}
